...
if (isset($_POST['submit'])) {
  ...
  $Description = $_POST['product_description'];
   ...
   $image_info = $_FILES['Picture'];
    ...
    $sqli = " UPDATE `tblproducts` SET `ProductID`='$productid',`ProductName`='$name',`ProductPrice`='$price',`ProductCode`='$code',`ProductInStock`='$stock',`ProductDiscount`='$discount',`ProductSizeses`='$sizes',`ProductDetails`='$Description',`ProductImage`='$img_path' WHERE ProductID=$id ";
